# Don't Remove Credit @MarsaNetwork
import asyncio
import os
import random
import sys
...
async def delete_broadcast(client: Bot, message: Message):
    if message.reply_to_message:
        try:
            ...
            await message.reply("<b>Please use a valid duration in seconds.</b> USAGES: /dbroadcast {duration}")
            return
        ...
        status = f"""<b><u>Broadcasting With Auto-Delete...</u>
